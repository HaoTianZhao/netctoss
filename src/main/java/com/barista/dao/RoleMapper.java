...
public interface RoleMapper {
    ...
    int insertSelective(Role record) throws SQLIntegrityConstraintViolationException;
    ...
    int updateByPrimaryKeySelective(Role record) throws SQLIntegrityConstraintViolationException;
